	...
	**/
	function displayGame()
	{
		...
		if (!$this->isOver())
		{
			...
			echo "
				<p align=\"center\">
					<input type=\"submit\" name=\"move\" value=\"Refresh\" onclick=\"return checkInfo();\" /><br/>
					<b>Game Name {$this->gN}</b><br>
					<b>It's player {$this->user}'s turn.</b><br>
					<b>Using Symbol: {$this->player}</b><br>
					<b>Score: {$this->setScore()}</b></p>
